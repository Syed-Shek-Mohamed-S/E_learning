...
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddAssignment`(
    IN p_course_id INT,
    IN p_assignment_title VARCHAR(255),
    IN p_assignment_description TEXT,
    IN p_due_date DATETIME
)
BEGIN
    INSERT INTO assignments (course_id, assignment_title, assignment_description, due_date)
    VALUES (p_course_id, p_assignment_title, p_assignment_description, p_due_date);
END ;;
DELIMITER ;
...
BEGIN
    INSERT INTO courses (course_code, course_name, professor_id, dept_id, credit_hours, course_description)
    VALUES (p_course_code, p_course_name, p_professor_id, p_dept_id, p_credit_hours, p_course_description);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddMajor`(
    IN p_dept_id INT,
    IN p_major_name VARCHAR(255)
)
BEGIN
    INSERT INTO majors (dept_id, major_name)
    VALUES (p_dept_id, p_major_name);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    INSERT INTO grades (student_id, course_id, assignment_id, grade)
    VALUES (p_student_id, p_course_id, p_assignment_id, p_grade);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    SELECT e.enroll_id, c.course_name, e.status
    FROM enrollments e
